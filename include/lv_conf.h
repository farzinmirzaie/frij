...
#define LV_USE_SYSMON   1  /* on-screen FPS/CPU overlay (Settings ▸ Debug toggle) */
#if LV_USE_SYSMON
    ...
    #define LV_USE_PERF_MONITOR 1  /* backs the Settings ▸ Debug performance overlay */
    #if LV_USE_PERF_MONITOR
        #define LV_USE_PERF_MONITOR_POS LV_ALIGN_CENTER  /* round screen: keep it in view */
...
/* Frij: enabled only for the emulator_StopWatch env (via -D FRIJ_USE_LV_SDL). */
#ifdef FRIJ_USE_LV_SDL
#define LV_USE_SDL              1
#else
#define LV_USE_SDL              0
#endif
